...
{% swagger method="get" path="/www.solidrocketfuel/api/v1/music/" baseUrl="https:/" summary="Gets a video by `id`" %}
{% swagger-description %}
This method gets a song by it's ID
...
{% swagger-response status="200: OK" description="A song url" %}
```javascript
{
